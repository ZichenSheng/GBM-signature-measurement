...
This is the authoritative repository for the current manuscript: [GBM-signature-measurement](https://github.com/ZichenSheng/GBM-signature-measurement). The earlier canonical-MES project remains separate. See [repository lineage](docs/REPOSITORY_LINEAGE.md) for the publication correction. A new manuscript-code DOI will be added to main after archival, without moving the v1.0.0 tag.
