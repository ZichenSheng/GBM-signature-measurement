# GBM signature measurement manuscript reproducibility
...
The current Results authority is the September 19, 2026 manuscript, with 78 claim-level entries and six main figures. This independent repository starts at v1.0.0 and follows the current six-section manuscript. See [authority](docs/CURRENT_RESULTS_AUTHORITY.md), [claim crosswalk](docs/RESULT_CODE_CROSSWALK.tsv) and [figure map](docs/RESULT_MAP.md).
...
Claim-scoped measurement qualification is implemented in [MeasureQual v0.10.0](https://github.com/ZichenSheng/MeasureQual) (doi:[10.5281/zenodo.22846512](https://doi.org/10.5281/zenodo.22846512); software concept DOI [10.5281/zenodo.22846292](https://doi.org/10.5281/zenodo.22846292)). MeasureQual is not vendored or an execution dependency of these manuscript modules.

This is the authoritative repository for the current manuscript: [GBM-signature-measurement](https://github.com/ZichenSheng/GBM-signature-measurement). The earlier canonical-MES project remains separate. See [repository lineage](docs/REPOSITORY_LINEAGE.md) for the publication correction. The manuscript-code v1.0.0 version DOI is [10.5281/zenodo.22851963](https://doi.org/10.5281/zenodo.22851963); its independent concept DOI is [10.5281/zenodo.22851962](https://doi.org/10.5281/zenodo.22851962). Citation metadata was added to main after archival; the v1.0.0 tag remains immutable.
